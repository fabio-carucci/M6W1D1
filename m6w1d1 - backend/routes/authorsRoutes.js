...
const { getAuthors, getAuthorById, getAuthorByEmail, createAuthor, updateAuthorById, deleteAuthor, updateAvatarByAuthorId } = require('../controllers/authorsController');
